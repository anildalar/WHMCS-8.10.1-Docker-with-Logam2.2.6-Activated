...
RSThemes - Website Builder - Add New Location Modal
...
<div 
    ...
    id="addNewLocationItemModal" 
    data-add-new-location-item-modal
>
    <div class="modal__dialog">
        <div class="modal__content">
            {* 1. Modal Top *}
            <div class="modal__top top">
                <h4 class="top__title h6">Add Location {include file="adminarea/includes/helpers/docs.tpl" link=$cms_docs->modal['item']['add_edit']['location']}</h4>
            ...
            <form 
                ...
                data-add-new-location-item-form 
            ...
            >
                <div class="modal__body has-scroll">
                    ...
                    <div class="modal__section">
                        ...
                        <div class="form-group form-group--language">
                            ...
                            <select class="form-control" name="item[location]" data-location-select required>                                
                        ...
                        <div class="collapse" id="add-new-location-custom" data-location-custom>
                            {* 2.1.2. Title *}
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="number" name="item[location_position_top]" value=""/>
                                    </div>    
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="number" name="item[location_position_left]" value=""/>
                                    </div>    
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="item[location_status]" data-default-select-value="none">
                        ...
                        {* 2.1.11. Graphic Container *}
                        <div class="collapse show" id="location-add-modal-tabs" data-icons-tabs>
                            {include file="adminarea/pages/includes/modal/other/icon-tabs.tpl" type='location-add'}
                        </div>
                    </div>
                    ...
                    <div 
                        ...
                        data-toggle="lu-collapse" 
                        data-target="#addNewLocation-advanced-settings" 
                    ...
                    <div class="modal__section-content collapse" id="addNewLocation-advanced-settings" data-product-advanced-settings>
                        {* 2.2.1. Custom Item Class *}
                ...
                <div class="modal__actions">
                    <button class="btn btn--primary" data-add-new-location-btn  type="submit" form="addNewLocationForm">
