    ...
    <script type="text/javascript">       
        ...
        function initButtons()
        {
            ...
            postAJAX("credits|makeRefund", 
                {'userId' : userId, 'hostingId': hostingId, 'extensionPage': 'CreditBilling'},
                'json',
                "resultMessage",
                function(result){
                    if(result == "success")
        ...
        jQuery(document).ready(function(){
            ...
            jQuery("#MGPanel table").dataTable({
                ...
                searching: false,
                autoWidth: false,
                sAjaxSource: "addonmodules.php?module=AdvancedBilling&mg-page=credits&mg-action=getClientCreditsList&json=1&extensionPage=CreditBilling",
