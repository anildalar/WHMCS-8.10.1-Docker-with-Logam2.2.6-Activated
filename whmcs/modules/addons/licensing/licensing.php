...
function licensing_config()
{
    ...
    if (!LICENSINGADDONLICENSE) {
        ...
        $configarray["fields"] = ["clientverifytool" => ["FriendlyName" => "Public License Verification Tool", "Type" => "yesno", "Description" => "Tick this box to enable the Client Area License Verification Tool (accessed via /index.php?m=licensing)"], "maxreissues" => ["FriendlyName" => "Maximum Allowed Reissues", "Type" => "text", "Size" => "4", "Default" => "10", "Description" => "Enter the maximum number of reissues you want to allow (abuse protection)"], "logprune" => ["FriendlyName" => "Auto Logs Prune", "Type" => "text", "Size" => "4", "Default" => "90", "Description" => "Enter the number of days to keep license access log history for"]];
    }
    return $configarray;
}
