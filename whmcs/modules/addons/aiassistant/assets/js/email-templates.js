$(document).ready(function () {
    ...
    $('[name^="subject"]').after('<button style="margin-left: 5px" type="button" class="btn btn-sm btn-small btn-success ai_replay_item"><i class="fas fa-robot"></i> Write with AI</button>');
