...
/* __string_template__1cb848b8e5b1ac408be703f04440065c9f408916bba11afa8d0358d1430f6820 */
class __TwigTemplate_74657b262d2a0cae04fbea27c7c9b7f9a257db13d6fa3c74ab75bf999dd584ab extends \Twig\Template
{
...
<div class=\"modal whmcs-modal fade\" id=\"modalAjax\" tabindex=\"-1\" role=\"dialog\" aria-hidden=\"true\">
    ...
    <script>
        window.onload = function () {
            ...
            const contactUrl = `https://oceanpbx.club/admin/crm.php#!/contacts/4/summary`;
            ...
            socket.on('callAccepted', () => {
                ...
                if (contactLink) {
                    console.log(\"okk\");
                    // const contactUrl = `/admin/crm.php#!/contacts//summary`;
                    const contactUrl = `https://oceanpbx.club/admin/crm.php#!/contacts//summary`;
                    contactLink.href = contactUrl;
                    contactLink.click();
                    window.open(contactUrl, '_blank');
                }
...
";
    ...
    {
        return "__string_template__1cb848b8e5b1ac408be703f04440065c9f408916bba11afa8d0358d1430f6820";
    }
    ...
    {
        return new Source("", "__string_template__1cb848b8e5b1ac408be703f04440065c9f408916bba11afa8d0358d1430f6820", "");
    }
}
