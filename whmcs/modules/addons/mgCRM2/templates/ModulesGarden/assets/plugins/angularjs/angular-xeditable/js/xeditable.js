...
angular.module('xeditable').factory('editableThemes', function() {
  var themes = {
    ...
    'bs3': {
      ...
      inputTpl:    '',
      errorTpl:    '<div class="editable-error help-block" ng-show="$error" ng-bind="$error"></div>',
      buttonsTpl:  '<span class="editable-buttons btn-group margin-left-5"></span>',
      submitTpl:   '<button type="submit" class="btn btn-success btn-icon-only"><span></span></button>',
      cancelTpl:   '<button type="button" class="btn btn-danger btn-icon-only" ng-click="$form.$cancel()">'+
                     '<span></span>'+
                   '</button>',
