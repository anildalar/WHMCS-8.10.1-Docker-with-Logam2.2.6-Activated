                            ...
                            { 'background-color' : opt.overrideColor ? '#' + opt.color : 'transparent'},
                                        ...
                                        <div class="check-subtitle" v-if="(opt.fullprice == '0.00' && !field.hideZeroPrices) || opt.fullprice != '0.00' || opt.setup > 0">
                                            ...
                                            <span v-if="opt.setup > 0 && product.paytype !== 'free'">
                                                <span v-html="' + ' + currency.prefix + getFormattedPrice(opt.setup) + ' ' + (layoutSettings.displayPriceSuffix ? (' ' + currency.suffix) : '') + ' {$MGLANG->absoluteT('LagomOrderForm','product', 'setupFee')}'"></span>
                                            </span>
                                        </div>
        ...
        <div class="panel panel-body" v-else>
            <div class="form-group m-b-0">
                <select class="form-control" v-model="value">
                    ...
                    (option.setup > 0 ? (' + ' + currency.prefix + getFormattedPrice(option.setup) + ' ' + (layoutSettings.displayPriceSuffix ? (' ' + currency.suffix) : '') + ' {$MGLANG->absoluteT('LagomOrderForm','product', 'setupFee')}') : '') : '')"
                    ></option>
                </select>
            </div>
        </div>
