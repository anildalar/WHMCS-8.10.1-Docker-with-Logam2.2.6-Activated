mgJsComponentHandler.addDefaultComponent('mg-configurable-suboptions-groups', {
    template: '#t-mg',
    props: [
        'component_id',
        'component_namespace',
        ...
        tldGroupsSortableController: function () {
            ...
            $('#itemContentContainer tbody.vSortable').sortable(
            {
                stop: function(event, ui)
                {
                    ...
                    mgPageControler.vueLoader.updateSorting(order, 'assignTldForm', 'ModulesGarden_LagomOrderForm_App_UI_Admin_ConfigurableOptions_Forms_Details_Options_AddSuboptionsGroupForm');
                },
