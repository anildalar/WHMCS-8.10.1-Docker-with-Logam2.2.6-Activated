<div class="mg-wrapper body" data-target=".body" data-spy="scroll" data-twttr-rendered="true">
    ...
    <link rel="stylesheet" href="{$assetsURL}/css/layers-ui.css?version={$moduleVersion}">
    <link rel="stylesheet" href="{$assetsURL}/css/mg_styles.css?version={$moduleVersion}">
    <link rel="stylesheet" href="{$assetsURL}/css/module_styles.css?version={$moduleVersion}">
