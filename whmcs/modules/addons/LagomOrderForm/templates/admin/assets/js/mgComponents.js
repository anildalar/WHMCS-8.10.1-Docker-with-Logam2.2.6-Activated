...
function initModalTooltips(){
    ...
    $('.jscolor').each(function( index ) {
        new jscolor($(this).first()[0]);
    });
}
...
$(document).on('change', 'input[name="hideProductHostname"]', function () {
    const showHostname = $(this).is(':checked')
    $('input[name="hideHostnameForAllProducts"]').closest('.lu-form-check').toggle(showHostname)
    $('select[name="hideHostnameForSelectedGroups"]').closest('.lu-form-group').toggle(showHostname)
})
$('input[name="hideProductHostname"]').trigger('change')


$(document).on('change', 'input[name="hideProductNameservers"]', function () {
    const showNameservers = $(this).is(':checked')
    $('input[name="hideNameserversForAllProducts"]').closest('.lu-form-check').toggle(showNameservers)
    $('select[name="hideNameserversForSelectedGroups"]').closest('.lu-form-group').toggle(showNameservers)
})
$('input[name="hideProductNameservers"]').trigger('change')
