   ...
   */
					...
					_detailsInit: function _detailsInit() {
						...
						$(dt.table().body()).on('click.dtr mousedown.dtr mouseup.dtr', selector, function (e) {
							...
							// then take no action
							if (!$(dt.table().node()).hasClass('lu-collapsed')) {
								return;
							}
					...
					_resize: function _resize() {
						...
						$(dt.table().node()).toggleClass('lu-collapsed', collapsedClass);
					...
					_resizeAuto: function _resizeAuto() {
						...
						if (this.c.details.type === 'inline') {
							$(clonedTable).addClass('dtr-inline lu-collapsed');
						}
  ...
  */
		...
		/***/ (function(module, exports, __webpack_require__) {
			...
			var Default = {
				...
				pageLenght: 10,
				domPattern: '<t><"lu-t-c__footer table-footer"p B>',
				noSortClass: 'no-sort',
				hiddenClass: 'hidden'
			};
