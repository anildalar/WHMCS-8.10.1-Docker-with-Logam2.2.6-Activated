...
var mgDefauleVueObject = {
            ...
            methods: {
                ...
                loadModal : function(event, targetId, namespace, index, params, addSpinner){
                    ...
                    formData.append('loadData', targetId);
                    ...
                    formData.append('mgformtype', 'read');
                    ...
                    var request = $.post(self.targetUrl, postData, function(data){
                        data = data.data;
                ...
                submitForm : function(targetId, event) {
                    ...
                    if(formTargetId){
                        ...
                        self.refreshUrl();
                        formData.append('loadData', formTargetId);
                        formData.append('namespace', getItemNamespace(formTargetId));
                        formData.append('index', getItemIndex(formTargetId));
                        formData.append('ajax', '1');
                        formData.append('mgformtype', $('#'+formTargetId).attr('mgformtype'));
                        $.ajax({
                            type: "POST",
                            url: self.targetUrl,
                            data: formData,
