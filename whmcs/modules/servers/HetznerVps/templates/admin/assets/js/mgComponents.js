...
function tldCategoriesSortableController()
{
    ...
    if (! $('#groupList.vSortable').hasClass('ui-sortable'))
    {
        $("#groupList.vSortable").sortable(
        {
            ...
            stop: function(event, ui)
            {
                ...
                mgPageControler.vueLoader.updateSorting(order, 'addCategoryForm', 'ModulesGarden_HetznerVps_App_UI_Widget_DoeTldConfigComponents_CategoryForms_AddCategoryForm');
    ...
    $('#itemContentContainer tbody.vSortable').sortable(
    {
        stop: function(event, ui)
        {
            ...
            mgPageControler.vueLoader.updateSorting(order, 'assignTldForm', 'ModulesGarden_HetznerVps_App_UI_Widget_DoeTldConfigComponents_CategoryForms_AssignTldForm');
        },
...
function changePasswordElement() {
    let inputElement = document.getElementsByClassName('elementPasswordInput');
    let iconElement = document.getElementsByClassName('elementPasswordIcon');

    if (($(inputElement).attr('type')) == 'password') {
        ($(inputElement).attr('type', 'text'));
        ($(iconElement).attr('class', 'elementPasswordIcon lu-zmdi lu-zmdi-eye'));
    } else if (($(inputElement).attr('type')) == 'text') {
        ($(inputElement).attr('type', 'password'));
        ($(iconElement).attr('class', 'elementPasswordIcon lu-zmdi lu-zmdi-eye-off'));
    }
}
