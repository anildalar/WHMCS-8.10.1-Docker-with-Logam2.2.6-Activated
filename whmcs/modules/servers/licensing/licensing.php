...
function licensing_ConfigOptions()
{
    ...
    $configarray = ["Key Length" => ["Type" => "text", "Size" => "10", "Description" => "String Length eg. 10"], "Key Prefix" => ["Type" => "text", "Size" => "20", "Description" => "eg. Leased-"], "Allow Reissue" => ["Type" => "yesno", "Description" => "Tick to allow clients to self-reissue from the client area"], "Allow Domain Conflict" => ["Type" => "yesno", "Description" => "Tick to not validate Domains"], "Allow IP Conflict" => ["Type" => "yesno", "Description" => "Tick to not validate IPs"], "Allow Directory Conflict" => ["Type" => "yesno", "Description" => "Tick to not validate installation path"], "Support/Updates Addon" => ["Type" => "dropdown", "Options" => $supportUpdateAddons], "Secret Key" => ["Type" => "text", "Size" => "20", "Description" => "Used in MD5 Verification"], "Free Trial" => ["Type" => "yesno", "Description" => "Restricts license to one instance per Domain"]];
    return $configarray;
}
