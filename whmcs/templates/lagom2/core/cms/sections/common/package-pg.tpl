                ...
                {elseif isset($product['media'])}
                    <div class="package-graphic package-media">
                        {include file="{$smarty.current_dir}/graphic.tpl" 
                            ...
                            type="media"
                            elementTitle=$product['group']['name']
                        }
                    </div>
                {else}
