                                        ...
                                        <table style="border-collapse:collapse;border-color:transparent;border-spacing:0;padding:0;text-align:left;vertical-align:top;width:100%">
                                            <tr style="padding:0;text-align:left;vertical-align:top">
                                                <th valign="middle" height="49" style="Margin:0;color:#0a0a0a;font-family:Roboto,sans-serif;font-size:16px;font-weight:400;line-height:1.3;margin:0;padding:0;text-align:left;vertical-align:middle;height:49px;">
                                                    {if $logo.email_inverse}
                                                        <img width="200" class="header-logo"
                                                         src="{$logo.email_inverse}" alt=""
                                            ...
                                            <tr style="padding:0;text-align:right;vertical-align:top">
                                                <th style="Margin:0;color:#0a0a0a;font-family:Roboto,sans-serif;font-size:16px;font-weight:400;line-height:1.3;margin:0;padding:0;text-align:right">
                                                    <span class="header-top-text"
                                                          style="border-left-width:7px;border-left-color:transparent;border-left-style:solid;color:#ACB0B8;display:table;font-size:12px;line-height:29px;text-align:right;margin-left:auto;"> {$header_text}<a
                                                            class="faded-link" href="{$emailsURL}"
                                                            style="Margin:0;text-decoration:none;color:#8295b9!important;font-family:Roboto,sans-serif;font-weight:400;line-height:1.3;margin:0;padding:0;text-align:left;text-decoration:none;line-height:8px;"> <span style="text-decoration:none; color:#8295b9"><font color="#8295b9">{$header_link_text}</font></span></a></span>
                                                </th>
                                            </tr>
                                        </table>
                                    </th>
                ...
                <table cellpadding="0" cellspacing="0" border="0" align="center" class="container body-drip float-center"
                    ...
                    <tr style="padding:0;text-align:left;vertical-align:top">
                        <td style="-moz-hyphens:auto;-webkit-hyphens:auto;Margin:0;border-collapse:collapse!important;color:#0a0a0a;font-family:Roboto,sans-serif;font-size:16px;font-weight:400;hyphens:auto;line-height:1.3;margin:0;padding:0;text-align:left;vertical-align:top;word-wrap:break-word;max-width:580px!important">
                            <img width="580" height="8" src="{$assetsURL}/future/img/border-top.png" alt=""
