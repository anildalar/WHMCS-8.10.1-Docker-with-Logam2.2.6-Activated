                            ...
                            <div class="row" data-input-number>
                                ...
                                <div class="prod-price col" data-content="{$LANG.orderprice}">
                                    <div class="cart-item-price price price-xs">
                                        {if  ($product.pricing.totalTodayExcludingTaxSetup|replace:$WHMCSCurrency.suffix:""|replace:$WHMCSCurrency.prefix:""|replace:",":"." == '0.00' || $product.pricing.totalTodayExcludingTaxSetup|replace:$WHMCSCurrency.suffix:""|replace:$WHMCSCurrency.prefix:""|replace:",":"." == '0,00') && $productsPrices == "free"}
                                            {$LANG.orderpaymenttermfree} 
                                        {else}
                                            {if $displayPriceSuffix == "off"}{$product.pricing.totalTodayExcludingTaxSetup|replace:$WHMCSCurrency.suffix:""}{else}{$product.pricing.totalTodayExcludingTaxSetup}{/if}<span class="price-cycle-inline">{if $product.billingcycle !="free"}/{/if}{if $product.billingcycle =="onetime"}{$LANG.orderpaymenttermonetime}{elseif $product.billingcycle eq "monthly"}{$LANG.pricingCycleShort.monthly}{elseif $product.billingcycle eq "quarterly"}{$LANG.pricingCycleShort.quarterly}{elseif $product.billingcycle eq "semiannually"}{$LANG.pricingCycleShort.semiannually}{elseif $product.billingcycle eq "annually"}{$LANG.pricingCycleShort.annually}{elseif $product.billingcycle eq "biennially"}{$LANG.pricingCycleShort.biennially}{elseif $product.billingcycle eq "triennially"}{$LANG.pricingCycleShort.triennially}{/if}</span>
                                        {/if}
                                        {if $product.pricing.productonlysetup}
                                        + {if $displayPriceSuffix == "off"}{$product.pricing.productonlysetup|replace:$WHMCSCurrency.suffix:""}{else}{$product.pricing.productonlysetup}{/if} {$LANG.ordersetupfee}</span>
                                        {/if}
                                    </div>  
                                            ...
                                            {foreach key=confnum item=configoption from=$product.configoptions}
                                                <div class="addon-item row">
                                                    ...
                                                    <div class="addon-price col">
                                                        <span class="item-price" data-currency-prefix="{$WHMCSCurrency.prefix}" data-currency-suffix="{$WHMCSCurrency.suffix}" data-product-config-option="{$num}-{$confnum}">
                                                            {if $configoption.recurring|replace:$WHMCSCurrency.suffix:""|replace:$WHMCSCurrency.prefix:""|replace:",":"." && $configoption.recurring|replace:$WHMCSCurrency.suffix:""|replace:$WHMCSCurrency.prefix:""|replace:",":"." != 0}
                                                                {if $displayPriceSuffix == "off"}{$configoption.recurring|replace:$WHMCSCurrency.suffix:""}{else}{$configoption.recurring}{/if}
                                                            {else}
                                                                {if $configurableOptionsPrices != "hide" && $configurableOptionsPrices == "free"}{$LANG.orderpaymenttermfree}{elseif $configurableOptionsPrices != "hide"}{if $displayPriceSuffix == "off"}{$configoption.recurring|replace:$WHMCSCurrency.suffix:""}{else}{$configoption.recurring}{/if}{/if}
                                                            {/if}
                                                            {if $configoption.setup != ""}{if ($configoption.recurring|replace:$WHMCSCurrency.suffix:""|replace:$WHMCSCurrency.prefix:""|replace:",":"." == "0.00" || $configoption.recurring|replace:$WHMCSCurrency.suffix:""|replace:$WHMCSCurrency.prefix:""|replace:",":"." == "0,00") && $configurableOptionsPrices == "hide"}
                                                                {if $displayPriceSuffix == "off"}{$configoption.setup|replace:$WHMCSCurrency.suffix:""}{else}{$configoption.setup}{/if}
                                                            {else} 
                                                                + {if $displayPriceSuffix == "off"}{$configoption.setup|replace:$WHMCSCurrency.suffix:""}{else}{$configoption.setup}{/if}
                                                                {/if} 
                                                                {$LANG.ordersetupfee}
                                                    ...
                                                    <div class="addon-price col">
                                                        <span class="item-price" {if $showAddonQtyOptions && $addon.allowqty===2}data-input-number-secondary-price{/if}>
                                                            {if $addon.billingcycle != "free"}
                                                                <span {if ($addon.totaltoday|replace:$WHMCSCurrency.suffix:""|replace:$WHMCSCurrency.prefix:""|replace:",":"." == '0.00' || $addon.totaltoday|replace:$WHMCSCurrency.suffix:""|replace:$WHMCSCurrency.prefix:""|replace:",":"." == '0,00') && $addonsPrices == "hide" } class="hidden"{/if}>{if ($addon.totaltoday|replace:$WHMCSCurrency.suffix:""|replace:$WHMCSCurrency.prefix:""|replace:",":"." == '0.00' || $addon.totaltoday|replace:$WHMCSCurrency.suffix:""|replace:$WHMCSCurrency.prefix:""|replace:",":"." == '0,00') && $addonsPrices == "free" }{$LANG.orderpaymenttermfree}{else}{if $displayPriceSuffix == "off"}{$addon.totaltoday|replace:$WHMCSCurrency.suffix:""}{else}{$addon.totaltoday}{/if}{/if}{if !strstr($addon.totaltoday, '0.00') && !strstr($addon.totaltoday, '0,00')}/{if $addon.billingcycle =="free"}{$LANG.orderpaymenttermfree}{elseif $addon.billingcycle =="onetime"}{$LANG.orderpaymenttermonetime}{elseif $addon.billingcycle eq "monthly"}{$LANG.pricingCycleShort.monthly}{elseif $addon.billingcycle eq "quarterly"}{$LANG.pricingCycleShort.quarterly}{elseif $addon.billingcycle eq "semiannually"}{$LANG.pricingCycleShort.semiannually}{elseif $addon.billingcycle eq "annually"}{$LANG.pricingCycleShort.annually}{elseif $addon.billingcycle eq "biennially"}{$LANG.pricingCycleShort.biennially}{elseif $addon.billingcycle eq "triennially"}{$LANG.pricingCycleShort.monthly}{/if}{/if}</span>
                                                            {else}
                                                                -
                                                            {/if}
                                                            {if $addon.setup} 
                                                                    {if ($addon.totaltoday|replace:$WHMCSCurrency.suffix:""|replace:$WHMCSCurrency.prefix:""|replace:",":"." == '0.00' || $addon.totaltoday|replace:$WHMCSCurrency.suffix:""|replace:$WHMCSCurrency.prefix:""|replace:",":"." == '0,00') && $addonsPrices == "hide" }
                                                                        {if $displayPriceSuffix == "off"}{$addon.setup|replace:$WHMCSCurrency.suffix:""}{else}{$addon.setup} {/if}{else} + {if $displayPriceSuffix == "off"}{$addon.setup|replace:$WHMCSCurrency.suffix:""}{else}{$addon.setup}{/if}
                                                                    {/if} 
                                                                {$LANG.ordersetupfee}
                                                            {/if}
                            ...
                            <div class="row">
                                ...
                                <div class="prod-price col" data-content="{$LANG.orderprice}">
                                    <span class="cart-item-price">
                                        ...
                                        <span class="cart-item-price price price-xs">{if $domain.totaltoday|replace:$WHMCSCurrency.suffix:""|replace:$WHMCSCurrency.prefix:""|replace:",":"." == '0.00' && $domainsPrices == "free"}{$LANG.orderfree}{else}{if $displayPriceSuffix == "off"}{$domain.totaltoday|replace:$WHMCSCurrency.suffix:""}{else}{$domain.price}{/if}{$domain.shortYearsLanguage}{/if}</span>
                                            <span class="renewal cycle">
                                                {if isset($domain.renewprice) && $displayPriceSuffix == "off"}{lang key='domainrenewalprice'} <span class="renewal-price cycle">{$domain.prefixedRenewPrice}{$domain.shortRenewalYearsLanguage}{elseif isset($domain.renewprice)}{$domain.renewprice}{$domain.shortRenewalYearsLanguage}{/if}</span>
                                            </span>
                                        </span>
                                        <span class="{if count($domain.pricing) == 1 || $domain.type == 'transfer'}hidden{else}{/if}" data-domain-price-multi="{$domain.domain}">
                                            <div class="cart-item-pricing">
                                                <button class="btn btn-default" type="button" id="{$domain.domain}Pricing" name="{$domain.domain}Pricing" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                                                    <span data-domain-price-multi-price>{if $displayPriceSuffix == "off"}{$domain.totaltoday|replace:$WHMCSCurrency.suffix:""}{else}{$domain.price}{/if}{$domain.shortYearsLanguage}</span>
                                                    ...
                                                    {foreach $domain.pricing as $years => $price}
                                                        <li>
                                                            <a href="#" onclick="selectDomainPeriodInCart('{$domain.domain}', '{$price.register}', {$years}, '{if $years == 1}{lang key='orderForm.year'}{else}{lang key='orderForm.years'}{/if}');return false;">
                                                                {$years} {if $years == 1}{lang key='orderForm.year'}{else}{lang key='orderForm.years'}{/if} @ {if $displayPriceSuffix == "off"}{$price.register|replace:$WHMCSCurrency.suffix:""}{else}{$price.register}{/if}
                                                            </a>
                                                        </li>
                                                    {/foreach}
                                                </ul>
                                            ...
                                            <span class="renewal cycle">
                                                <span class="renewal-price cycle">{if isset($domain.renewprice) && $displayPriceSuffix == "off"}{lang key='domainrenewalprice'} {$domain.prefixedRenewPrice}{$domain.shortRenewalYearsLanguage}{elseif isset($domain.renewprice)}{lang key='domainrenewalprice'} {$domain.renewprice}{$domain.shortRenewalYearsLanguage}{/if}</span>
                                            </span>
                                        </span>
                                    </span>
                                </div>
                    ...
                    {foreach $renewalsByType['domains'] as $num => $domain}
                        <div class="panel-body cart-item">
                            <div class="row">
                                ...
                                <div class="prod-price col" data-content="{$LANG.orderprice}">
                                    <div class="cart-item-price price price-xs">
                                        {if $displayPriceSuffix == "off"}{$domain.price|replace:$WHMCSCurrency.suffix:""}{else}{$domain.price}{/if}<span class="price-cycle-inline">/{$domain.regperiod}{$LANG.pricingCycleShort.annually}</span>
                                    </div>
                                </div>
                                <div class="prod-actions">
                                    <div class="cart-item-actions d-flex">
                            ...
                            <div class="row" data-input-number>
                                ...
                                <div class="prod-price col" data-content="{$LANG.orderprice}">
                                    <span class="cart-item-price price price-xs" data-input-number-price>
                                        {if $displayPriceSuffix == "off"}{$addon.totaltoday|replace:$WHMCSCurrency.suffix:""}{else}{$addon.totaltoday}{/if}{if $addon.billingcycle != 'Free'}<span class="price-cycle-inline">/{if $addon.billingcycle =="free"}{$LANG.orderpaymenttermfree}{elseif $addon.billingcycle =="onetime"}{$LANG.orderpaymenttermonetime}{elseif $addon.billingcycle eq "monthly"}{$LANG.pricingCycleShort.monthly}{elseif $addon.billingcycle eq "quarterly"}{$LANG.pricingCycleShort.quarterly}{elseif $addon.billingcycle eq "semiannually"}{$LANG.pricingCycleShort.semiannually}{elseif $addon.billingcycle eq "annually"}{$LANG.pricingCycleShort.annually}{elseif $addon.billingcycle eq "biennially"}{$LANG.pricingCycleShort.biennially}{elseif $addon.billingcycle eq "triennially"}{$LANG.pricingCycleShort.monthly}{/if}</span>
                                        {/if}
                                        {if $addon.setup}+ {$addon.setup|replace:$WHMCSCurrency.suffix:""} {$LANG.ordersetupfee}{/if}
