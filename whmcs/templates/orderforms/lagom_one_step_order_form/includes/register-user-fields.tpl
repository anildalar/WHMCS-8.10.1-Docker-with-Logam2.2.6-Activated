...
{/if}
    ...
    <div class="row">
        {if is_array($hideBillingDetails) &&  !in_array("companyname", $hideBillingDetails)}
        ...
        {if $showTaxIdField && !in_array("tax_id", $hideBillingDetails)}
            <div class="col-sm-6 tax-input-container {if isset($orderBillingAdress.tax_id)}flex-order-{$orderBillingAdress.tax_id}{else}flex-order-9{/if}">
                <div class="form-group">
                    <label class="tax-label"for="inputTaxId" data-hide-tax="{$hideVat|implode:' '}">
            ...
            <div class="col-sm-6">
                <div class="form-group ">
                    <div class="password-content password-content-top password-content-group">
                        ...
                        <span class="text-small text-lighter password-content-text"><span id="passwordStrengthTextLabel">{$LagomOrderFormLang->absoluteTranslate('LagomOrderForm','form','field','password','at_least')}</span><i data-toggle="tooltip" title="{$LANG.passwordtips}" data-html="true" data-container="body" class="ls ls-info-circle m-l-1x"></i></span>
                    </div>
                    ...
                    {include file="orderforms/$carttpl/includes/pwstrenght.tpl"}
                </div>
            </div>
            <div class="col-sm-6">
                <div class="form-group ">
            ...
            <div class="row">
                <div class="form-group col-sm-6">
                    <label for="inputSecurityQId" class="label-required">
                        {$LagomOrderFormLang->absoluteTranslate('LagomOrderForm','form','field','Security Question')}
                    </label>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            if(document.querySelector('.tax-input-container')){
                let taxLabelArray = document.querySelector('.tax-label').getAttribute("data-hide-tax").split(" ");
                let taxInputContainer = document.querySelector('.tax-input-container');
                let inputCountry = document.querySelector('#inputCountry')

                function hideTax(){
                    if(taxLabelArray.includes(inputCountry.value)){
                ...
                hideTax();
                inputCountry.addEventListener("change", hideTax);
            }
        });
    </script>
{/if}