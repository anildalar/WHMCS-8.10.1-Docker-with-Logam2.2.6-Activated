<?php
/* Smarty version 3.1.48, created on 2024-09-13 11:24:53
  from '/var/www/html/templates/lagom2/clientareaproductdetails.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.48',
  'unifunc' => 'content_66e421051ba518_31590819',
...
function content_66e421051ba518_31590819 (Smarty_Internal_Template $_smarty_tpl) {
...
<form method="post" action="clientarea.php?action=productdetails&id=<?php echo $_GET['id'];?>
">
    <?php if ($_smarty_tpl->tpl_vars['customfields']->value) {?>
        <?php
...
?>
            <?php if ($_smarty_tpl->tpl_vars['customfield']->value['name'] == "domain_for_pbx") {?>
                <p>
                    <strong>Domain for PBX:</strong>
                    <input type="text" name="customfield[<?php echo $_smarty_tpl->tpl_vars['customfield']->value['id'];?>
]" value="<?php echo $_smarty_tpl->tpl_vars['customfield']->value['value'];?>
" />
                </p>
            <?php }?>
        <?php
