...
function content_66dff7ac29d0c7_22143618 (Smarty_Internal_Template $_smarty_tpl) {
...
$_smarty_tpl->tpl_vars['cycle']->index++;
$_smarty_tpl->tpl_vars['cycle']->first = !$_smarty_tpl->tpl_vars['cycle']->index;
$__foreach_cycle_6_saved = $_smarty_tpl->tpl_vars['cycle'];
?>
                                        <?php $_smarty_tpl->_assignInScope('switchActive', false);?>
                                        <?php $_smarty_tpl->_assignInScope('discount', false);?>
                                        <?php $_smarty_tpl->_assignInScope('dataDiscount', false);?>
...
?>   
                                    <?php
$_smarty_tpl->tpl_vars['cycle'] = $__foreach_cycle_6_saved;
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?> 
                                <?php }?>  
                            </div>
...
$__foreach_d_7_saved = $_smarty_tpl->tpl_vars['d'];
...
$_smarty_tpl->tpl_vars['d'] = $__foreach_d_7_saved;
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>]'
                                                <?php }?>
                                            >
...
$_smarty_tpl->tpl_vars['cycle']->index++;
$_smarty_tpl->tpl_vars['cycle']->first = !$_smarty_tpl->tpl_vars['cycle']->index;
$__foreach_cycle_9_saved = $_smarty_tpl->tpl_vars['cycle'];
?>
                                                <?php $_smarty_tpl->_assignInScope('switchActive', false);?>
                                                <?php $_smarty_tpl->_assignInScope('discount', false);?>
                                                <?php $_smarty_tpl->_assignInScope('dataDiscount', false);?>
...
?>   
                                            <?php
$_smarty_tpl->tpl_vars['cycle'] = $__foreach_cycle_9_saved;
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?> 
                                        <?php }?>  
                                    </div>
