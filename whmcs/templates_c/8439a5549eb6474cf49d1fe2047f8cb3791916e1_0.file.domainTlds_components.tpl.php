...
/* Smarty version 3.1.48, created on 2024-12-21 07:18:56
  from '/var/www/html/modules/addons/LagomOrderForm/app/UI/Client/Templates/baseFormComponents/widgets/components/domainTlds_components.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.48',
  'unifunc' => 'content_67666be0737fb8_22040029',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '8439a5549eb6474cf49d1fe2047f8cb3791916e1' => 
    array (
      0 => '/var/www/html/modules/addons/LagomOrderForm/app/UI/Client/Templates/baseFormComponents/widgets/components/domainTlds_components.tpl',
      1 => 1734760265,
      2 => 'file',
    ),
  ),
...
function content_67666be0737fb8_22040029 (Smarty_Internal_Template $_smarty_tpl) {
echo '<script'; ?>
 type="text/x-template" id="t-mg-one-page-domain-tlds-<?php echo strtolower($_smarty_tpl->tpl_vars['elementId']->value);?>
"
...
>
    <div class="section" :class="[{ 'section--full-width': !showNumber}]" v-if="isVisible">
        ...
        <div class="section-header has-toolbar">
            <h2 class="section-title"><?php echo $_smarty_tpl->tpl_vars['MGLANG']->value->absoluteT('LagomOrderForm','domains','section','title','tlds');?>
</h2>
            <div class="section-toolbar">
                <form autocomplete="off">
                    <div class="tld-filters">
                        <span class="tld-filters-label"><?php echo $_smarty_tpl->tpl_vars['MGLANG']->value->absoluteT('view');?>
:</span>
...
" v-model="searchedWord">
        ...
        <div class="section-body" >
                ...
                <table class="table table-list">
                    <thead>
                        <tr class="tld-pricing-header">
                            <th>
                                <?php echo $_smarty_tpl->tpl_vars['MGLANG']->value->absoluteT('LagomOrderForm','domains','tlds','domains');?>

                            </th>
                            <th>
                                <?php echo $_smarty_tpl->tpl_vars['MGLANG']->value->absoluteT('LagomOrderForm','domains','tlds','domainsregister');?>

                            </th>
                            <th>
                                <?php echo $_smarty_tpl->tpl_vars['MGLANG']->value->absoluteT('LagomOrderForm','domains','tlds','domainstransfer');?>

                            </th>
                            <th>
                                <?php echo $_smarty_tpl->tpl_vars['MGLANG']->value->absoluteT('LagomOrderForm','domains','tlds','domainsrenew');?>
                    ...
                    <tbody>
                        <tr class="tld-row"  v-for="tld in tldToShow" v-if="tld['pricing'] && tld['pricing'][currencyId]">
                            <td>
                                ...
                                <span class="label label-info" v-if="tld.group === 'sale'"><?php echo $_smarty_tpl->tpl_vars['MGLANG']->value->absoluteT('LagomOrderForm','domains','tlds','sale');?>
</span>
                                <span class="label label-success" v-if="tld.group === 'new'"><?php echo $_smarty_tpl->tpl_vars['MGLANG']->value->absoluteT('LagomOrderForm','domains','tlds','new');?>
</span>
                                <span class="label label-danger" v-if="tld.group === 'hot'"><?php echo $_smarty_tpl->tpl_vars['MGLANG']->value->absoluteT('LagomOrderForm','domains','tlds','hot');?>
</span>
                            </td>
                            <td>
                                <span class="tld-label"><?php echo $_smarty_tpl->tpl_vars['MGLANG']->value->absoluteT('LagomOrderForm','domains','tlds','register');?>
</span>
                                ...
                                <small v-else><?php echo $_smarty_tpl->tpl_vars['MGLANG']->value->absoluteT('LagomOrderForm','domains','tlds','period','notAvailable');?>
</small>
                            </td>
                            <td>
                                <span class="tld-label"><?php echo $_smarty_tpl->tpl_vars['MGLANG']->value->absoluteT('LagomOrderForm','domains','tlds','transfer');?>
</span>
                            ...
                            <td>
                                <span class="tld-label"><?php echo $_smarty_tpl->tpl_vars['MGLANG']->value->absoluteT('LagomOrderForm','domains','tlds','renew');?>
</span>
            ...
            <div class="message message-danger message-lg message-no-data no-tlds" v-if="searchedWord != null && searchedWord != '' && tldToShow.length == 0">
                ...
                <h3 class="message-title message-text"><?php echo $_smarty_tpl->tpl_vars['MGLANG']->value->absoluteT('LagomOrderForm','domains','tlds','noResult');?>
</h3>
            </div>
            <div class="message message-danger message-lg message-no-data no-tlds" v-else-if="groups && groups.length > 0 && selectedGroup.length == 0">
                ...
                <h3 class="message-title message-text"><?php echo $_smarty_tpl->tpl_vars['MGLANG']->value->absoluteT('LagomOrderForm','domains','tlds','noCategory');?>
</h3>
            </div>
        </div>
    </div>
