...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.48',
  'unifunc' => 'content_66dfbb55f1c8f2_76558822',
...
function content_66dfbb55f1c8f2_76558822 (Smarty_Internal_Template $_smarty_tpl) {
    ...
    <div class="t-c__top top m-b-3x" data-top-search data-toggler-options="toggleClass: is-open;">
        <div class="top__toolbar">
            <h3 class="section__title">
                Website Pages
                <?php $_smarty_tpl->_subTemplateRender("file:adminarea/includes/helpers/docs.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('link'=>$_smarty_tpl->tpl_vars['cms_docs']->value->pages['website_pages']), 0, false);
?>
            </h3>
        ...
        <div class="top__toolbar is-right">
            ...
            <button
                    class="btn btn--primary <?php if (empty($_smarty_tpl->tpl_vars['pagesAdded']->value)) {?> is-disabled <?php }?>"
                    type="button"
                    data-add-new-page
                    data-ajax-url="<?php echo $_smarty_tpl->tpl_vars['helper']->value->url('CustomPage@customPageVerify',array('templateName'=>$_smarty_tpl->tpl_vars['template']->value->getMainName()));?>
"
                    data-location-href="<?php echo $_smarty_tpl->tpl_vars['helper']->value->url('CustomPage@new',array('templateName'=>$_smarty_tpl->tpl_vars['template']->value->getMainName()));?>
"
            >
    ...
    <div class="section">
        <?php if (!empty($_smarty_tpl->tpl_vars['pagesAdded']->value)) {?>
                        ...
                        <tr>
                            <td class="cell-name">
                                <div class="content-name">
                                    <a href="<?php echo $_smarty_tpl->tpl_vars['helper']->value->url('CustomPage@show',array('templateName'=>$_smarty_tpl->tpl_vars['template']->value->getMainName(),'pageId'=>$_smarty_tpl->tpl_vars['websitePage']->value->id));?>
"><strong><?php echo ucfirst($_smarty_tpl->tpl_vars['websitePage']->value->name);?>
</strong></a>
                                </div>
                            </td>
                           
                            <td class="cell-url">
                                <?php if ($_smarty_tpl->tpl_vars['homepageId']->value == $_smarty_tpl->tpl_vars['websitePage']->value->id) {?>
...
/index.php" target="_blank">
                                ...
                                <?php } else { ?>
                                    <a href="<?php echo $_smarty_tpl->tpl_vars['whmcsURL']->value;?>
/<?php echo $_smarty_tpl->tpl_vars['websitePage']->value->url;?>
" target="_blank">
                                        <span>/<?php echo $_smarty_tpl->tpl_vars['websitePage']->value->url;?>
</span>
                                    </a>
                                <?php }?>
                            </td>
                            <td class="cell-status" <?php if ($_smarty_tpl->tpl_vars['websitePage']->value->settings['published']) {?>data-order="1"<?php } else { ?>data-order="999999999999"<?php }?>>
                                <?php if ($_smarty_tpl->tpl_vars['websitePage']->value->settings['published']) {?>
                            ...
                            <td class="cell-seo">
                                <div class="status">
                                    <?php if ($_smarty_tpl->tpl_vars['websitePage']->value->seo_enabled) {?>
                            ...
                            <td class="cell-actions">
                                <a class="btn btn--xs btn--default btn--outline" href="<?php echo $_smarty_tpl->tpl_vars['helper']->value->url('CustomPage@show',array('templateName'=>$_smarty_tpl->tpl_vars['template']->value->getMainName(),'pageId'=>$_smarty_tpl->tpl_vars['websitePage']->value->id));?>
">
            ...
            <div class="section__body  panel ">
                <div class="section__builder">
                    ...
                    <div class="builder__actions">
                        <a class="btn btn--primary m-r-1x" href="<?php echo $_smarty_tpl->tpl_vars['helper']->value->url('CustomPage@loadCustomPages',array('templateName'=>$_smarty_tpl->tpl_vars['template']->value->getMainName(),'load'=>true,'tab'=>'website'));?>
" data-btn-loader>
                            <span class="btn__preloader preloader preloader--light"></span>
                            <span class="btn__text">Load Theme Pages</span>
                        </a>
                        <a class="btn btn--secondary" href="<?php echo $_smarty_tpl->tpl_vars['helper']->value->url('CustomPage@loadCustomPages',array('templateName'=>$_smarty_tpl->tpl_vars['template']->value->getMainName(),'load'=>false,'tab'=>'website'));?>
" data-btn-loader>
