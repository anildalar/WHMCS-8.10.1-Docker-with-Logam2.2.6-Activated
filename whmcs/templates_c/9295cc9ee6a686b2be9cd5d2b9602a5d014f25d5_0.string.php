...
/* Smarty version 3.1.48, created on 2024-09-20 11:36:31
  from '9295cc9ee6a686b2be9cd5d2b9602a5d014f25d5' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.48',
  'unifunc' => 'content_66ed5e3fa154a9_97314374',
...
function content_66ed5e3fa154a9_97314374 (Smarty_Internal_Template $_smarty_tpl) {
?>            <!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"
        "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en" style="background:#fff!important" <?php if ($_smarty_tpl->tpl_vars['rtl']->value == '1') {?> dir="rtl" <?php }?>>
<head>
                                ...
                                <tr style="padding:0;text-align:left;vertical-align:top">
                                    <th class="small-12 large-6 columns first"
                                        ...
                                        <table style="border-collapse:collapse;border-color:transparent;border-spacing:0;padding:0;text-align:left;vertical-align:top;width:100%">
                                            <tr style="padding:0;text-align:left;vertical-align:top">
                                                <th valign="middle" height="49" style="Margin:0;color:#0a0a0a;font-family:Roboto,sans-serif;font-size:16px;font-weight:400;line-height:1.3;margin:0;padding:0;text-align:left;vertical-align:middle">
                                                    <?php if ($_smarty_tpl->tpl_vars['logo']->value['email_light']) {?>
                                                        <img width="200" class="header-logo"
                                                         src="<?php echo $_smarty_tpl->tpl_vars['logo']->value['email_light'];?>
" alt=""
                                            ...
                                            <tr style="padding:0;text-align:right;vertical-align:top">
                                                <th style="Margin:0;color:#0a0a0a;font-family:Roboto,sans-serif;font-size:16px;font-weight:400;line-height:1.3;margin:0;padding:0;text-align:right">
                                                    <span class="header-top-text"
                                                          style="color:#ACB0B8;display:table;font-size:12px;line-height:29px;text-align:right;width:100%;margin-left:auto;"><?php echo $_smarty_tpl->tpl_vars['header_text']->value;?>
<a
                                                            class="faded-link" href="<?php echo $_smarty_tpl->tpl_vars['emailsURL']->value;?>
"
                                                            style="Margin:0;color:#7C8088!important;font-family:Roboto,sans-serif;font-weight:400;line-height:1.3;margin:0;padding:0;text-align:right;text-decoration:none;margin-left:6px;line-height:8px"><?php echo $_smarty_tpl->tpl_vars['header_link_text']->value;?>
</a></span>
                                                </th>
                                            </tr>
                                        </table>
