...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.48',
  'unifunc' => 'content_66ea636149b0b2_28017991',
...
function content_66ea636149b0b2_28017991 (Smarty_Internal_Template $_smarty_tpl) {
    ...
    <div class="t-c__top top" data-top-search data-toggler-options="toggleClass: is-open;">
        <div class="top__toolbar">
            <h3 class="section__title">
                Predefined Sections
                <?php $_smarty_tpl->_subTemplateRender("file:adminarea/includes/helpers/docs.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('link'=>$_smarty_tpl->tpl_vars['cms_docs']->value->pages['predefined_sections']), 0, false);
?>
            </h3> 
        </div>
                        ...
                        <tr>
                            <td class="cell-title">
                                <div class="content-name">
                                    <a href="<?php echo $_smarty_tpl->tpl_vars['helper']->value->url('Section@edit',array('templateName'=>$_smarty_tpl->tpl_vars['template']->value->getMainName(),'sectionId'=>$_smarty_tpl->tpl_vars['section']->value->id));?>
"><strong><?php echo $_smarty_tpl->tpl_vars['section']->value['name'];?>
</strong></a>
                                </div>
                            </td>
                            <td class="cell-template">
                                <div class="content-name">
                                    <strong><?php echo $_smarty_tpl->tpl_vars['section']->value->type['name'];?>
</strong>
                                </div>
                            </td>
                            <td class="cell-actions">
                                <a class="btn btn--xs btn--default btn--outline" href="<?php echo $_smarty_tpl->tpl_vars['helper']->value->url('Section@edit',array('templateName'=>$_smarty_tpl->tpl_vars['template']->value->getMainName(),'sectionId'=>$_smarty_tpl->tpl_vars['section']->value->id));?>
">
            ...
            <div class="section__body  panel ">
                <div class="section__builder">
                    ...
                    <div class="builder__actions">
                        <a class="btn btn--primary m-r-1x" href="<?php echo $_smarty_tpl->tpl_vars['helper']->value->url('CustomPage@loadCustomPages',array('templateName'=>$_smarty_tpl->tpl_vars['template']->value->getMainName(),'load'=>true,'tab'=>'section'));?>
">
                            <span class="btn__text">
                                Load Theme Pages
                            </span>
                        </a>
                        <a class="btn btn--secondary" href="<?php echo $_smarty_tpl->tpl_vars['helper']->value->url('CustomPage@loadCustomPages',array('templateName'=>$_smarty_tpl->tpl_vars['template']->value->getMainName(),'load'=>false,'tab'=>'section'));?>
">
                            <span class="btn__text">
                                Start From Scratch
                            </span>
